...
// // Set up deep mock chain structure for update and delete
// const mockDb = {
...
//       const updateMock = (mockDb.update as jest.Mock).mock.results[0].value;
//       updateMock.set().where.mockResolvedValueOnce({ rowCount: 0 });
...
//       const deleteMock = (mockDb.delete as jest.Mock).mock.results[0].value;
